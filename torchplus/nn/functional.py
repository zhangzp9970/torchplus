...
def mse_with_weight_loss(input: torch.Tensor, target: torch.Tensor, weight: torch.Tensor, reduction: str = 'mean') -> torch.Tensor:
...
def pixel_loss(input: torch.Tensor, target: torch.Tensor, threshold: Optional[float] = 0.0, reduction: str = 'mean') -> torch.Tensor:
